...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "unlockBOT"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", '1gj9ufubyUdi1rzm'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/unlockBOT.css"); // Project stylesheet file name
...
$PROJECT_ID = "{1B294467-F675-48C8-9632-26D78A5119EB}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "unlockdb", "port" => 5432, "user" => "unlockpa", "pass" => "unlockpa", "db" => "unlockpa", "schema" => "unlockpa", "qs" => "\"", "qe" => "\"");
...
$LANGUAGE_FILE = [];
$LANGUAGE_FILE[] = ["it", "", "italian.xml"];
define(PROJECT_NAMESPACE . "LANGUAGE_DEFAULT_ID", "it");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_TABLE", "\"unlockpa\".\"userlevels\"");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_TABLE", "\"unlockpa\".\"userlevelpermissions\"");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "utenti");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "mail");
...
define(PROJECT_NAMESPACE . "USER_PROFILE_FIELD_NAME", "profile_field_memo");
define(PROJECT_NAMESPACE . "REGISTER_ACTIVATE_FIELD_NAME", "status");
define(PROJECT_NAMESPACE . "USER_EMAIL_FIELD_NAME", "mail");

// User table filters
define(PROJECT_NAMESPACE . "USER_TABLE_DBID", "DB");
define(PROJECT_NAMESPACE . "USER_TABLE", "\"unlockpa\".\"utenti\"");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(\"mail\" = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "(\"id\" = %u)");
define(PROJECT_NAMESPACE . "USER_EMAIL_FILTER", "(\"mail\" = '%e')");
define(PROJECT_NAMESPACE . "USER_ACTIVATE_FILTER", "(\"status\" = 1)");
...
define(PROJECT_NAMESPACE . "SMTP_SERVER", "TOCHANGE"); // SMTP server
...
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "TOCHANGE"); // Sender email address
...
define(PROJECT_NAMESPACE . "UPLOAD_DEST_PATH", "logo/"); // Upload destination path (relative to app root)
...
define(PROJECT_NAMESPACE . "UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,csv"); // Allowed file extensions
