...
var fcomuniadd = currentForm = new ew.Form("fcomuniadd", "add");

// Validate form
fcomuniadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($comuni_add->istat->Required) { ?>
		...
		<?php if ($comuni_add->toponimo->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->telefono->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->indirizzo->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->provincia->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->avviso->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->fk_zona->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->no_response->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->dominio->Required) { ?>
		...
		<?php if ($comuni_add->vide->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->botattivo->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->logo->Required) { ?>
			elm = this.getElements("x" + infix + "_logo");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $comuni->logo->caption(), $comuni->logo->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($comuni_add->logobin->Required) { ?>
		...
		<?php } ?>
		<?php if ($comuni_add->vide_url->Required) { ?>
...
fcomuniadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcomuniadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcomuniadd.lists["x_fk_zona"] = <?php echo $comuni_add->fk_zona->Lookup->toClientList() ?>;
fcomuniadd.lists["x_fk_zona"].options = <?php echo JsonEncode($comuni_add->fk_zona->lookupOptions()) ?>;
fcomuniadd.lists["x_vide[]"] = <?php echo $comuni_add->vide->Lookup->toClientList() ?>;
fcomuniadd.lists["x_vide[]"].options = <?php echo JsonEncode($comuni_add->vide->options(FALSE, TRUE)) ?>;
fcomuniadd.lists["x_botattivo[]"] = <?php echo $comuni_add->botattivo->Lookup->toClientList() ?>;
fcomuniadd.lists["x_botattivo[]"].options = <?php echo JsonEncode($comuni_add->botattivo->options(FALSE, TRUE)) ?>;
...
<?php $comuni_add->showPageHeader(); ?>
<?php
$comuni_add->showMessage();
?>
<form name="fcomuniadd" id="fcomuniadd" class="<?php echo $comuni_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($comuni_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $comuni_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="comuni">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$comuni_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($comuni->istat->Visible) { // istat ?>
	<div id="r_istat" class="form-group row">
		<label id="elh_comuni_istat" for="x_istat" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->istat->caption() ?><?php echo ($comuni->istat->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->istat->cellAttributes() ?>>
...
<?php if ($comuni->toponimo->Visible) { // toponimo ?>
	<div id="r_toponimo" class="form-group row">
		<label id="elh_comuni_toponimo" for="x_toponimo" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->toponimo->caption() ?><?php echo ($comuni->toponimo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->toponimo->cellAttributes() ?>>
...
<?php if ($comuni->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group row">
		<label id="elh_comuni_telefono" for="x_telefono" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->telefono->caption() ?><?php echo ($comuni->telefono->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->telefono->cellAttributes() ?>>
...
<?php if ($comuni->indirizzo->Visible) { // indirizzo ?>
	<div id="r_indirizzo" class="form-group row">
		<label id="elh_comuni_indirizzo" for="x_indirizzo" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->indirizzo->caption() ?><?php echo ($comuni->indirizzo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->indirizzo->cellAttributes() ?>>
...
<?php if ($comuni->provincia->Visible) { // provincia ?>
	<div id="r_provincia" class="form-group row">
		<label id="elh_comuni_provincia" for="x_provincia" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->provincia->caption() ?><?php echo ($comuni->provincia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->provincia->cellAttributes() ?>>
...
<?php if ($comuni->avviso->Visible) { // avviso ?>
	<div id="r_avviso" class="form-group row">
		<label id="elh_comuni_avviso" for="x_avviso" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->avviso->caption() ?><?php echo ($comuni->avviso->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->avviso->cellAttributes() ?>>
...
<?php if ($comuni->fk_zona->Visible) { // fk_zona ?>
	<div id="r_fk_zona" class="form-group row">
		<label id="elh_comuni_fk_zona" for="x_fk_zona" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->fk_zona->caption() ?><?php echo ($comuni->fk_zona->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->fk_zona->cellAttributes() ?>>
...
<?php if ($comuni->no_response->Visible) { // no_response ?>
	<div id="r_no_response" class="form-group row">
		<label id="elh_comuni_no_response" for="x_no_response" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->no_response->caption() ?><?php echo ($comuni->no_response->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->no_response->cellAttributes() ?>>
...
<?php if ($comuni->dominio->Visible) { // dominio ?>
	<div id="r_dominio" class="form-group row">
		<label id="elh_comuni_dominio" for="x_dominio" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->dominio->caption() ?><?php echo ($comuni->dominio->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->dominio->cellAttributes() ?>>
...
<?php if ($comuni->vide->Visible) { // vide ?>
	<div id="r_vide" class="form-group row">
		<label id="elh_comuni_vide" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->vide->caption() ?><?php echo ($comuni->vide->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->vide->cellAttributes() ?>>
...
<?php if ($comuni->botattivo->Visible) { // botattivo ?>
	<div id="r_botattivo" class="form-group row">
		<label id="elh_comuni_botattivo" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->botattivo->caption() ?><?php echo ($comuni->botattivo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->botattivo->cellAttributes() ?>>
...
<?php } ?>
<?php if ($comuni->logo->Visible) { // logo ?>
	<div id="r_logo" class="form-group row">
		<label id="elh_comuni_logo" for="x_logo" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->logo->caption() ?><?php echo ($comuni->logo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->logo->cellAttributes() ?>>
<span id="el_comuni_logo">
<input type="text" data-table="comuni" data-field="x_logo" name="x_logo" id="x_logo" placeholder="<?php echo HtmlEncode($comuni->logo->getPlaceHolder()) ?>" value="<?php echo $comuni->logo->EditValue ?>"<?php echo $comuni->logo->editAttributes() ?>>
</span>
<?php echo $comuni->logo->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($comuni->logobin->Visible) { // logobin ?>
	<div id="r_logobin" class="form-group row">
		<label id="elh_comuni_logobin" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->logobin->caption() ?><?php echo ($comuni->logobin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->logobin->cellAttributes() ?>>
...
<?php if ($comuni->vide_url->Visible) { // vide_url ?>
	<div id="r_vide_url" class="form-group row">
		<label id="elh_comuni_vide_url" for="x_vide_url" class="<?php echo $comuni_add->LeftColumnClass ?>"><?php echo $comuni->vide_url->caption() ?><?php echo ($comuni->vide_url->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comuni_add->RightColumnClass ?>"><div<?php echo $comuni->vide_url->cellAttributes() ?>>
...
<?php if (!$comuni_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $comuni_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $comuni_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$comuni_add->showPageFooter();
if (DEBUG_ENABLED)
