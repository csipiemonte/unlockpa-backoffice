...
// Create page object
$knowledge_base_add = new knowledge_base_add();

// Run the page
$knowledge_base_add->run();
...
$knowledge_base_add->Page_Render();
?>
...
var fknowledge_baseadd = currentForm = new ew.Form("fknowledge_baseadd", "add");

// Validate form
fknowledge_baseadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($knowledge_base_add->ts_creation->Required) { ?>
		...
		<?php if ($knowledge_base_add->question_type->Required) { ?>
		...
		<?php } ?>
		<?php if ($knowledge_base_add->question_number->Required) { ?>
		...
		<?php } ?>
		<?php if ($knowledge_base_add->question->Required) { ?>
		...
		<?php } ?>
		<?php if ($knowledge_base_add->answer->Required) { ?>
		...
		<?php } ?>
		<?php if ($knowledge_base_add->note->Required) { ?>
		...
		<?php } ?>
		<?php if ($knowledge_base_add->id_bot->Required) { ?>
...
fknowledge_baseadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fknowledge_baseadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $knowledge_base_add->showPageHeader(); ?>
<?php
$knowledge_base_add->showMessage();
?>
<form name="fknowledge_baseadd" id="fknowledge_baseadd" class="<?php echo $knowledge_base_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($knowledge_base_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $knowledge_base_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="knowledge_base">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$knowledge_base_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($knowledge_base->ts_creation->Visible) { // ts_creation ?>
	<div id="r_ts_creation" class="form-group row">
		<label id="elh_knowledge_base_ts_creation" for="x_ts_creation" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->ts_creation->caption() ?><?php echo ($knowledge_base->ts_creation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->ts_creation->cellAttributes() ?>>
...
<?php if ($knowledge_base->question_type->Visible) { // question_type ?>
	<div id="r_question_type" class="form-group row">
		<label id="elh_knowledge_base_question_type" for="x_question_type" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->question_type->caption() ?><?php echo ($knowledge_base->question_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->question_type->cellAttributes() ?>>
...
<?php if ($knowledge_base->question_number->Visible) { // question_number ?>
	<div id="r_question_number" class="form-group row">
		<label id="elh_knowledge_base_question_number" for="x_question_number" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->question_number->caption() ?><?php echo ($knowledge_base->question_number->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->question_number->cellAttributes() ?>>
...
<?php if ($knowledge_base->question->Visible) { // question ?>
	<div id="r_question" class="form-group row">
		<label id="elh_knowledge_base_question" for="x_question" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->question->caption() ?><?php echo ($knowledge_base->question->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->question->cellAttributes() ?>>
...
<?php if ($knowledge_base->answer->Visible) { // answer ?>
	<div id="r_answer" class="form-group row">
		<label id="elh_knowledge_base_answer" for="x_answer" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->answer->caption() ?><?php echo ($knowledge_base->answer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->answer->cellAttributes() ?>>
...
<?php if ($knowledge_base->note->Visible) { // note ?>
	<div id="r_note" class="form-group row">
		<label id="elh_knowledge_base_note" for="x_note" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->note->caption() ?><?php echo ($knowledge_base->note->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->note->cellAttributes() ?>>
...
<?php if ($knowledge_base->id_bot->Visible) { // id_bot ?>
	<div id="r_id_bot" class="form-group row">
		<label id="elh_knowledge_base_id_bot" for="x_id_bot" class="<?php echo $knowledge_base_add->LeftColumnClass ?>"><?php echo $knowledge_base->id_bot->caption() ?><?php echo ($knowledge_base->id_bot->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $knowledge_base_add->RightColumnClass ?>"><div<?php echo $knowledge_base->id_bot->cellAttributes() ?>>
...
<?php if (!$knowledge_base_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $knowledge_base_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $knowledge_base_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$knowledge_base_add->showPageFooter();
if (DEBUG_ENABLED)
