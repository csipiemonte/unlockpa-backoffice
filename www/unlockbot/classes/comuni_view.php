 ...
 * Page class
 */
class comuni_view extends comuni
{
	...
	// Page object name
	public $PageObjName = "comuni_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "comunilist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "comunilist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "comunilist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
