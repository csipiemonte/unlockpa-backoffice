 ...
 * Page class
 */
class knowledge_base_view extends knowledge_base
{
	...
	// Page object name
	public $PageObjName = "knowledge_base_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "knowledge_baselist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "knowledge_baselist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "knowledge_baselist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
