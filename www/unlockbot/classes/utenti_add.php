 ...
 * Page class
 */
class utenti_add extends utenti
{
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "utentiview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// fk_comune
		$this->fk_comune->setDbValueDef($rsnew, $this->fk_comune->CurrentValue, NULL, FALSE);
