 ...
 * Page class
 */
class categorie_view extends categorie
{
	...
	// Page object name
	public $PageObjName = "categorie_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("categorielist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "categorielist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "categorielist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "categorielist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("categorielist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
