...
class userlevels extends DbTable
{
	...
	public function __construct()
	{
		...
		// Update Table
		$this->UpdateTable = "\"unlockpa\".\"userlevels\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('userlevels', 'userlevels', 'x_userlevelid', 'userlevelid', '"userlevelid"', 'CAST("userlevelid" AS varchar(255))', 3, -1, FALSE, '"userlevelid"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "\"unlockpa\".\"userlevels\"";
	}
