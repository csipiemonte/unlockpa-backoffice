 ...
 * Page class
 */
class utenti_view extends utenti
{
	...
	// Page object name
	public $PageObjName = "utenti_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "utentilist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "utentilist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "utentilist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
