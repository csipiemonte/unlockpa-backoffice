 ...
 * Page class
 */
class knowledge_base_delete extends knowledge_base
{
	...
	// Page object name
	public $PageObjName = "knowledge_base_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("knowledge_baselist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("knowledge_baselist.php"); // Return to list
			}
		}
	}
