 ...
 * Page class
 */
class comuni_delete extends comuni
{
	...
	// Page object name
	public $PageObjName = "comuni_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("comunilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("comunilist.php"); // Return to list
			}
		}
	}
