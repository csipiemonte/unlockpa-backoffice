 ...
 * Page class
 */
class utenti_delete extends utenti
{
	...
	// Page object name
	public $PageObjName = "utenti_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("utentilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("utentilist.php"); // Return to list
				return;
			}
		}
