 ...
 * Page class
 */
class knowledge_base_edit extends knowledge_base
{
	...
	// Page object name
	public $PageObjName = "knowledge_base_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ts_creation
			$this->ts_creation->setDbValueDef($rsnew, UnFormatDateTime($this->ts_creation->CurrentValue, 0), NULL, $this->ts_creation->ReadOnly);

			// question_type
			$this->question_type->setDbValueDef($rsnew, $this->question_type->CurrentValue, NULL, $this->question_type->ReadOnly);

			// question_number
			$this->question_number->setDbValueDef($rsnew, $this->question_number->CurrentValue, NULL, $this->question_number->ReadOnly);
			...
			// id_bot
			$this->id_bot->setDbValueDef($rsnew, $this->id_bot->CurrentValue, NULL, $this->id_bot->ReadOnly);
