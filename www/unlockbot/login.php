...
setTimeout( () => {
	$('.login-page .ew-login-form').addClass('login-unlockBOT'),
	$('.login-page .ew-login-form .form-group').removeClass('row'),
	$('.login-page .ew-login-form .ew-btn').addClass('btn-block text-uppercase'),
	$('.login-page .card-body').prepend('<div class="login-logo"><img src="phpimages/new_assets/logo_unlock.svg"/></div>')
}, 10 );
</script>
<script>
