...
$('body').addClass('unlockBot');
$('body').css('display', 'none');
setTimeout(() => {
$('.unlockBot').addClass('body-page')
}, 150);
setTimeout(() => {
$('.body-page .main-sidebar .brand-link .brand-text').remove(),
$('.body-page .main-sidebar .brand-link').prepend('<div class="text-center"><img src="phpimages/new_assets/logo_unlock.svg" width="59px"/></div>'),
$('.body-page .main-sidebar #ew-menu .nav-item .nav-link .fa').removeClass('fa-angle-left'),
$('.body-page .main-sidebar #ew-menu .nav-item .nav-link .fa').addClass('fa-angle-down'),
$('button.ew-search-toggle').append('<span> Cerca </span>')
$('#ew-navbar').append('<li class="nav-item""><img src="phpimages/new_assets/logo_mobile.svg" width="35px"/></li>')
}, 200);
setTimeout(() => {
